...
export default function AuthWarningModal({ 
  ...
  title = "İstatistik Uyarısı", 
  description = "Klasik mod hariç istatistiklerinizin kaydedilmesi ve sıralamaya girmek için giriş yapmanız gerekir." 
      ...
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: spacing.xl }}>
        <Animated.View style={[{
          ...
          <View style={{
            ...
            <Ionicons name="stats-chart" size={moderateScale(28)} color={Colors.correct.main} />
          </View>
          ...
          <View style={{ width: '100%', gap: verticalScale(10) }}>
            ...
            >
              <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: moderateScale(14), fontWeight: '600' }}>
                Girişsiz Devam Et
              </Text>
            </TouchableOpacity>
          </View>
